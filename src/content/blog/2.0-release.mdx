...
cover: ../../assets/blog-posts/v2-release/cover.png
---
...
<video src="/videos/stateq12025/Vectors.webm" loop muted autoPlay controls playsinline/>
...
<video src="/videos/stateq12025/Island.webm" muted autoPlay loop controls playsinline/>

__Fully procedural fire__
<video src="/videos/v2-release/fire.webm" muted autoPlay loop controls playsinline/>
...
<video src="/videos/stateq12025/Workspace.webm" loop autoplay mute controls playsinline/>
...
<video src="/videos/stateq12025/Slime.webm" loop autoplay mute controls playsinline/>

But that's not the end, except classic cels you can utilize node graph to create procedural animations.

<video src="/videos/stateq12025/Anim.webm" loop autoplay mute controls playsinline/>
...
<video src="/videos/stateq12025/PixelPerfect.webm" loop muted autoPlay controls playsinline/>

#### Transform (scale, move, skew, rotate, perspective) selection and layers
<video src="/videos/stateq12025/Skew.webm" loop muted autoPlay controls playsinline/>


#### Non-destructive, pixel-perfect text tool
<video src="/videos/stateq12025/TextPp.webm" loop muted autoPlay controls playsinline/>
...
<iframe maxWidth={500} class='w-full' height="315" src="https://www.youtube-nocookie.com/embed/D-C0NyARIM8?si=iAVCYvjoDndkIFQx" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
