...
So, what should you expect? On our internal roadmap we have things like:
{/* Here I thought it is a list of tutorial ideas */}
...
{/* On top you say it is a standalone platform, and then it is far from it. I got excited with how I can use Drawie and then read that actually I can't */}
...
At the beginning of the month I was supposed to be in the mountains, a longer break from coding and managing the project. Well I was, but after a few days I broke my foot and was forced to go back in front of the computer.
...
Why not add 3D rendering to Drawie? Making a 3D renderer is already a fun thing, but no too hard itself. More challenging part was adding a 3D pipeline and integrating it with Skia. My goal
