...
import OldToolset from "./assets/devlog3/oldToolset.png"
import NewToolset from "./assets/devlog3/newToolset.png"
...
![PixiEditor 2.0 UI](./assets/devlog3/newUI.png)
...
Old:
<Image src={OldToolset} alt="Old icons" class="w-[100px]" />


New:
<Image src={NewToolset} alt="New icons" class="w-[100px]" />
...
<video src="/videos/devlog3/docking.webm" style={{width: "100%"}} autoPlay muted/>
...
<video src="/videos/devlog3/anim.webm" style={{width: "100%"}} autoPlay muted loop/>
