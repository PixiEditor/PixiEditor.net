---
title: Can PixiEditor become 2D industry standard? 2026 Roadmap
authors: [ flabbet ] 
...
It means that you'll be able to run .pixi files outside PixiEditor. For example, in your game engine directly. Because why not? Skipping the import and adjustment part can save a lot of time.
