...
![palette-viewer](./assets/devlog2/Palette-viewer.png)
...
<video class="blog-video" controls>
  <source src="/videos/devlog2/Color-replacer.webm" type="video/webm"/>
...
![palette-browser](./assets/devlog2/Palette-Browser.png)
...
<video class="blog-video" controls>
  <source src="/videos/devlog2/Lospec-Import.webm" type="video/webm"/>
  Your browser does not support the video tag.
</video>
...
![context-menu](./assets/devlog2/Context-menu.png)
...
![search-open](./assets/devlog2/Search-open.png)

This opens up the new search bar.

![search-window](./assets/devlog2/Search-window.png)
...
![search-set-hex](./assets/devlog2/Search-set-hex.png)

![search-set-rgb](./assets/devlog2/Search-set-rgb.png)
...
![search-kenobi](./assets/devlog2/Search-kenobi.png)
...
<video class="blog-video" controls>
    <source src="/videos/devlog2/Layers.webm" type="video/webm"/>
    Your browser does not support the video tag.
</video>
...
<video class="blog-video" controls>
    <source src="/videos/devlog2/Lasso-Transform.webm" type="video/webm"/>
    Your browser does not support the video tag.
</video>
...
<video class="blog-video" controls>
    <source src="/videos/devlog2/Selection-Clipping.webm" type="video/webm"/>
    Your browser does not support the video tag.
</video>
...
<video class="blog-video" controls>
    <source src="/videos/devlog2/Move-Viewport.webm" type="video/webm"/>
    Your browser does not support the video tag.
</video>
...
<video class="blog-video" controls>
    <source src="/videos/dynamic-bitmaps.webm" type="video/webm"/>
    Your browser does not support the video tag.
</video>
...
<video class="blog-video" controls>
    <source src="/videos/devlog2/Chunk-Vis.webm" type="video/webm"/>
    Your browser does not support the video tag.
</video>
...
<video class="blog-video" controls>
    <source src="/videos/devlog2/Symmetry.webm" type="video/webm"/>
    Your browser does not support the video tag.
</video>
