...
So join me on [Libre Graphics Meeting 2026](https://libregraphicsmeeting.org/2026/) in Nuremberg! [I'll be giving a talk about PixiEditor on April 25th](https://libregraphicsmeeting.org/2026/program/talk_power_of_node_driven_2d_workflows/). 
...
We have not decided on prices yet, and details of extensions are not final.

We're planning to release 2 bigger extensions and some brush packs.

### Advanced pixel art toolset
...
Some things may not be obvious. One of these things is smart layers. In version 2.1, importing anything from the outside of the editor will be imported as a smart layer by default. This allows you to directly
use another .pixi or .svg file as a layer. 

To keep things consistent, normal .png or other image files work this way too. It additionally solves the problem of cutting off parts of the image if you transform it outside of the document bounds.
...
I added this little guy to a few more places. It not only asks questions but also gives tips. Can you find all of them?
...
Up to this day, we have been using .NET Standard 2.0 Qoi.Netstandard encoder, which performs quite poorly. We had a choice to use another, faster library or write our own solution. All the libraries we tested 
had issues here and there, so we've decided on building it from scratch.
...
Thank you for reading it all the way down! We are putting countless hours into PixiEditor, we actually care about building a powerful free tool that can compete and outperform other proprietary solutions. 

If you think that what we do here is useful, please consider supporting us with a Founder's Bundle, share the word about PixiEditor with a friend, your community or a family member. Also if you have .pixi files, that we could test against PixiEditor 2.1, don't forget to send them [here](https://forms.gle/QNmY1RsdkQMysfrV7)!

With love,

flabbet, Mushy and PixiEditor Team