---
title: A story about multithreaded rendering | September Status
...
Here's a quick comparision of new renderer with heavy animation
...
Here's a preview with shrinked visible area to see the effect
...
Please note that new renderer is not yet released. It will require some more testing before it lands in the development version.
...
We are still working on fixes and improvements after 2.0 release along with a Brush Engine. Hopefully I'll have more news about it in October status update. 
