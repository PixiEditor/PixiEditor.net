...
The quickest way to talk with us is on our discord server. 
You can make an issue or comment on an existing one. 
If you want to work on an issue, keep in mind that some issues can be unexpectedly difficult for those unfamiliar with the project, and some may even be invalid (since anyone can make one).
